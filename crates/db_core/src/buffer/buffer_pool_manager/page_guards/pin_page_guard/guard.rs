...
mod tests {
    ...
    fn should_not_unpin_when_getting_read_pin_guard_from_guard() {
...

        {
            ...
            assert_eq!(page.get_pin_count(), 3, "Creating read guard from regular guard should keep pin count");
        }
    ...
    fn should_not_unpin_when_getting_write_pin_guard_from_guard() {
...

        {
            ...
            assert_eq!(page.get_pin_count(), 3, "Creating write guard from regular guard should keep pin count");
        }
    ...
    fn should_allow_upgrading_and_downgrading() {
...

        {
            ...
            // Should not unpin
            assert_eq!(page.get_pin_count(), pin_count, "should have the same pin count");
